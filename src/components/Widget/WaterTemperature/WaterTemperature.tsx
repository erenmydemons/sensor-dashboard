...
export interface WaterTemperatureProps extends WidgetLoaderPassProps {}

const WaterTemperature: FC<WaterTemperatureProps> = ({ name, description, setting, ...props }) => {
  ...
  return (
    <div {...props} className={clsx(setting?.className, 'p-4 flex flex-col items-center justify-center bg-black rounded-md w-full')}>
      <div className="mt-2 text-center">
        <span className="text-5xl font-bold block text-white mb-2">{temperature}oF</span>
      </div>
